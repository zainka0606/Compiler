...
struct PatternSource {
    enum class Kind { Regex, StringLiteral };
...
class SpecParseException : public std::runtime_error {
  public:
    SpecParseException(std::size_t offset, std::size_t line, std::size_t column,
                       std::string message);
...
class LexerRuntimeException : public std::runtime_error {
  public:
    LexerRuntimeException(std::size_t offset, std::size_t line,
...
inline constexpr std::size_t kInvalidAcceptRuleIndex =
